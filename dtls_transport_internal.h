...
#ifndef _C_P2P_BASE_DTLS_TRANSPORT_INTERNAL_H_
#define _C_P2P_BASE_DTLS_TRANSPORT_INTERNAL_H_
...
class DtlsTransportInternal : public libice::PacketTransportInternal {
 public:
