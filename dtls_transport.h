...
#ifndef _C_P2P_BASE_DTLS_TRANSPORT_H_
#define _C_P2P_BASE_DTLS_TRANSPORT_H_
...
class DtlsTransport : public DtlsTransportInternal {
 ...
 private:
  ...
  void OnReadPacket(libice::PacketTransportInternal* transport,
                    ...
                    int flags);
  void OnSentPacket(libice::PacketTransportInternal* transport,
                    const rtc::SentPacket& sent_packet);
  void OnReadyToSend(libice::PacketTransportInternal* transport);
  void OnReceivingState(libice::PacketTransportInternal* transport);
