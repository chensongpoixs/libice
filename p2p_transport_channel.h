...
#ifndef _C_P2P_BASE_P2P_TRANSPORT_CHANNEL_H_
#define _C_P2P_BASE_P2P_TRANSPORT_CHANNEL_H_
...
#include "libice/candidate_pair_interface.h"
...
#include "libice/p2p_transport_channel_ice_field_trials.h"
...
class RTC_EXPORT P2PTransportChannel : public IceTransportInternal {
 ...
 private:
  ...
  std::unique_ptr<libice::BasicRegatheringController> regathering_controller_
      RTC_GUARDED_BY(network_thread_);
  ...
  libice::IceTransportState state_ RTC_GUARDED_BY(network_thread_) =  libice::IceTransportState::STATE_INIT;
