...
#ifndef _C_P2P_BASE_PACKET_TRANSPORT_INTERNAL_H_
#define _C_P2P_BASE_PACKET_TRANSPORT_INTERNAL_H_
...
class RTC_EXPORT PacketTransportInternal : public sigslot::has_slots<> {
 public:
  ...
  virtual absl::optional<rtc::NetworkRoute> network_route() const;
