...
#ifndef _C_P2P_BASE_ICE_TRANSPORT_INTERNAL_H_
#define _C_P2P_BASE_ICE_TRANSPORT_INTERNAL_H_
...
class RTC_EXPORT IceTransportInternal : public libice::PacketTransportInternal {
 public:
  ...
  sigslot::signal1<const libice::CandidatePairChangeEvent&>
