...
#ifndef _C_API_ICE_TRANSPORT_INTERFACE_H_
#define _C_API_ICE_TRANSPORT_INTERFACE_H_
...
class IceTransportInterface : public rtc::RefCountInterface {
 public:
  ...
  virtual libice::IceTransportInternal* internal() = 0;
};
...
struct IceTransportInit final {
 public:
  ...
  libice::PortAllocator* port_allocator() { return port_allocator_; }
  void set_port_allocator(libice::PortAllocator* port_allocator) {
  ...
  webrtc::RtcEventLog* event_log() { return event_log_; }
  void set_event_log(webrtc::RtcEventLog* event_log) { event_log_ = event_log; }

 private:
  libice::PortAllocator* port_allocator_ = nullptr;
  webrtc::AsyncDnsResolverFactoryInterface* async_dns_resolver_factory_ = nullptr;
  // For backwards compatibility. Only one resolver factory can be set.
  webrtc::AsyncResolverFactory* async_resolver_factory_ = nullptr;
  webrtc::RtcEventLog* event_log_ = nullptr;
