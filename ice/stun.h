...
#ifndef _C_API_TRANSPORT_STUN_H_
...
class StunAddressAttribute : public StunAttribute {
 public:
  ...
  StunAttributeValueType value_type() const ;
...
class RelayMessage : public StunMessage {
 protected:
  StunAttributeValueType GetAttributeValueType(int type) const ;
  StunMessage* CreateNew() const ;
};
