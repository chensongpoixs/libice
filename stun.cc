...
{
	//   transaction_id 固定长度12 或者 16
  RTC_DCHECK(transaction_id.length() == libice::kStunTransactionIdLength ||
             transaction_id.length() == libice::kStunLegacyTransactionIdLength);
