...
#ifndef _C_P2P_BASE_DEFAULT_ICE_TRANSPORT_FACTORY_H_
#define _C_P2P_BASE_DEFAULT_ICE_TRANSPORT_FACTORY_H_
...
class DefaultIceTransport : public IceTransportInterface {
 ...
 private:
  ...
  std::unique_ptr<libice::P2PTransportChannel> internal_
