...
rtc::PacketInfoProtocolType ConvertProtocolTypeToPacketInfoProtocolType(
    libice::ProtocolType type) {
  switch (type) {
    case libice::ProtocolType::PROTO_UDP:
      return rtc::PacketInfoProtocolType::kUdp;
    case libice::ProtocolType::PROTO_TCP:
      return rtc::PacketInfoProtocolType::kTcp;
    case libice::ProtocolType::PROTO_SSLTCP:
      return rtc::PacketInfoProtocolType::kSsltcp;
    case libice::ProtocolType::PROTO_TLS:
...
const int kPortTimeoutDelay = libice::STUN_TOTAL_TIMEOUT + 5000;
...
static const char* const PROTO_NAMES[] = { cricket::UDP_PROTOCOL_NAME, cricket::TCP_PROTOCOL_NAME,
										  cricket::SSLTCP_PROTOCOL_NAME,
...
void Port::AddAddress(const rtc::SocketAddress& address,
                      ...
                      bool is_final) {
  if (protocol == cricket::TCP_PROTOCOL_NAME && type == LOCAL_PORT_TYPE) {
...
void Port::UpdateNetworkCost() {
  ...
  for (libice::Candidate& candidate : candidates_) {
