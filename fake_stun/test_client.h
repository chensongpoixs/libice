...
#ifndef _C_TEST_CLIENT_H_
#define _C_TEST_CLIENT_H_
...
class TestClient : public sigslot::has_slots<> {
 public:
  ...
  struct Packet {
    Packet(const rtc::SocketAddress& a,
           const char* b,
           size_t s,
  ...
  rtc::SocketAddress remote_address() const { return socket_->GetRemoteAddress(); }
